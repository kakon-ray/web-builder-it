@extends('layouts.app')
@section('title')
    {{ 'Show Password Reset Form| Web Builder IT ' }}
@endsection
                    ...
                    <div class="panel-body">
                        ...
                        <div class="text-center">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="{{ route('student.new.password.submit') }}" method="POST">
                                    @csrf

                                    <input type="text" name="token" value="{{ $token }}" hidden>
                                    <div class="my-3">
                                        <input id="email" name="email" placeholder="email address"
                                            class="form-control" type="email" value="{{$email}}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input name="recover-submit" class="common-btn ms-0 py-2 btn-block"
