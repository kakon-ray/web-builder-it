    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center py-5">
                ...
                @else
                <h4 class="mb-1 py-3 fw-bold">Total Amount : {{ $course_details->course_fee }} (BDT)</h4>
                @endif
                <h4>Pement Method</h4>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6">
                                ...
                                <p>
                                    @php
                                    echo substr($course_details->desc, 0, 500);
                                    @endphp
                ...
                <div class="pt-5">
                            ...
                            <form action="{{ route('student.pay') }}" method="POST" class="needs-validation">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            class="form-control" id="customer_name" placeholder="Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-select" name="phone" aria-label="Default select example">
                                            <option selected value="01707500512">01707500512</option>
                                            <option value="01538407195">01538407195</option>
                                        </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address"
                                        placeholder="1234 Main St" value="{{Auth::guard('student')->user()->address}}"
                                        required>
                                </div>
                    ...
                    <div class="manual">
                        ...
                        <div class="text-center pb-3">
                            <p>ম্যানুয়াল পেমেন্ট করলে আমাদের বিকাশ মার্চেন্ট নাম্বারে
                                @if($course_details->new_course_fee)
                                <span class="fw-bold">{{ $course_details->new_course_fee }}</span>

                                @else
                                <span class="fw-bold">{{ $course_details->course_fee }}</span>
                                @endif টাকা পাঠাতে হবে।
                            </p>
                            <p> 01707500512 / 01538407195</p>
                        </div>
                            ...
                            <form action="{{ route('student.add.pement.submit') }}" method="POST"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="number" name="amount" class="form-control"
                                        @if($course_details->new_course_fee) value="{{$course_details->new_course_fee}}"
                                    @else value="{{$course_details->course_fee}}" @endif/>
                                </div>

                                <div class="form-outline password-container mb-4">
                                    <label class="form-label" id="from_number_lebel" for="loin_form">যে নাম্বারে টাকা
                                        পাঠিয়েছেন</label>
                                    <select class="form-select" name="send_phone_num"
