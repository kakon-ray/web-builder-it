    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li
            ...
            <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white mb-1 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('admin.course.add.catagory') }}">Add Course Catagory</a>
                </div>
            </div>
            <div id="collapsePages2" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white mb-1 collapse-inner rounded">
                    <a class="collapse-item" href="{{ route('admin.manage.course.catagory') }}">Manage Course Catagory</a>
                </div>
            </div>
