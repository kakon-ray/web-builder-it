...
<p>You can reset password from this link <a href="{{route('admin.reset.password',$token)}}">Reset Password</a></p>
 --}}
    ...
    <body
        ...
        <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td class="content-cell"
                                            ...
                                            <div class="f-fallback">
                                                <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: center;"
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px;">
                                                                        <a target="_blank"
                                                                            href="{{ route('admin.reset.password', $token) }}"
                                                ...
                                                <!-- Sub copy -->
                                                <p class="f-fallback sub" style="text-align:center;">Click and Reset Your Password </p>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
