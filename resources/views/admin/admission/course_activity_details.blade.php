...
@section('title', 'Course Activity Details')

@section('content')
@foreach ($activeCourse as $item)
@php
    $courseTitle = $item->add_course->course_title
@endphp
...
@endforeach
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-center ">{{$courseTitle}}<span style="color:#4e73df;"> Activity</span></h3>
            </div>
            ...
            <div class="col-lg-12 table-responsive">
                <table id="VisitorDt" class="table table-bordered dataTable" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        @foreach ($activeCourse as $item)
                            @if ($item->add_course->id == $course_id)
                                                ...
                                                <div class="modal-content ">
                                                    ...
                                                    <div class="modal-body text-start">
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="student_add_amount" placeholder="Pement Amount">
                                                        </div>
                                                    </div>
